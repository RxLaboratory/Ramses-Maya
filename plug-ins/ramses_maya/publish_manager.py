...
def publisher(file_path, item, step, publish_options=None, show_publish_options=False):
    ...
    ram.log("Publishing in: " + os.path.dirname(publish_info.filePath()), ram.LogLevel.Info )
